...
// Returns the location to use to store cached response headers in the permanent storage for a particular url
- (NSString *)pathToPermanentlyStoreCachedResponseDataForUrl:(NSURL *)url; // Pulse Edit
